...
public class myFetchService extends IntentService
{
    ...
    private void getData (String timeFrame)
    {
        ...
        //Log.d(LOG_TAG, "Api key:" + getString(R.string.api_key)); //todo: COMMENT OUT BEFORE RELEASE!
        //Opening Connection
        try {
        ...
        try {
            ...
            for(int i = 0;i < matches.length();i++)
            {
                        ...
                        League.equals(PRIMERA_DIVISION) ) //  || League.equals(DUMMYLEAGUE))
                {
                    ...
                    SimpleDateFormat match_date = new SimpleDateFormat("yyyy-MM-ddHH:mm:ss");// To get local formatting use getDateInstance(), getDateTimeInstance(), or getTimeInstance(), or use new SimpleDateFormat(String template, Locale locale) with for example Locale.US for ASCII dates
                    match_date.setTimeZone(TimeZone.getTimeZone("UTC"));
                    try {
                        Date parseddate = match_date.parse(mDate+mTime);
                        SimpleDateFormat new_date = new SimpleDateFormat("yyyy-MM-dd:HH:mm"); //  To get local formatting use getDateInstance(), getDateTimeInstance(), or getTimeInstance(), or use new SimpleDateFormat(String template, Locale locale) with for example Locale.US for ASCII dates
